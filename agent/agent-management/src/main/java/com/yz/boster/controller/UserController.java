package com.yz.boster.controller;
...
import com.yz.boster.commons.shiro.PasswordHash;
...
public class UserController extends BaseController {
	...
	@ResponseBody
	public Object checkExist(String loginName) {
		if (loginName == null) {
			return renderError("请输入用户名!");
		}
		User user = userService.selectOneByLoginName(loginName);
		if (user != null) {
			return 1;
		} else {
			return 0;
	...
	public Object add(UserVo userVo) {
		...
		User user = userService.selectOneByLoginName(userVo.getLoginName());
		if (user != null) {
	...
	public Object editUserPwd(String oldPwd, String pwd) {
		...
		userService.updatePwdByUserId(getUserId(),
				passwordHash.toHex(pwd, salt));
